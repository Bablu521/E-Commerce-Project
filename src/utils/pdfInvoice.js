...
function generateHeader(doc) {
  doc
    .fillColor("#444444")
    .fontSize(20)
    .text("E-Commerce Project.", 110, 57)
    .fontSize(10)
    .text("E-Commerce Project.", 200, 50, { align: "right" })
    .text("Mansoura", 200, 65, { align: "right" })
...
function generateInvoiceTable(doc, invoice) {
  ...
  generateTableRow(
    ...
    "Discount",
    "",
    formatCurrency(invoice.subtotal - invoice.finalPrice)
  );
